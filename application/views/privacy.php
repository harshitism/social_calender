...
<div class="main_section container"">
	...
	<div class="col-md-8 well">
			...
			<div class="row">
				...
				<div class="col-md-8">
					who can see your future posts<br>
			...
			<div class="row">
				...
				<div class="col-md-8">
					who can send you friend requests?<br>
			...
			<div class="row">
				...
				<div class="col-md-8">
					who can look you using email address provided?<br>
					who can loop u up using the phone no?
				</div>
				<div class="col-md-1">
					<a>Edit</a>
				</div>
