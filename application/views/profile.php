		...
		<div class="row main_section">
			...
			<div class="col-md-3">
				...
				<div class="btn-group btn-group-justified">
  					<div class="btn-group">
    					<button type="button" onClick="window.location='<?php echo $this->config->base_url();?>index.php/editprofile'" class="btn btn-default" style="width:265px" >Edit My Profile</button>
  					</div>
  				</div>
  				<br />
