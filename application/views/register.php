                ...
                <!--Password-->
                      <div class="form-group">
                         <label for="userpassword_signin" class="col-sm-2 control-label"></label>
                            <input type="password" class="form-control" id="userpassword_signin" name="user_password" placeholder="Password" onkeyup="passwordValidate(this)">
...
<script src="<?php echo $this->config->base_url();?>assets/js/validations.js"></script>
