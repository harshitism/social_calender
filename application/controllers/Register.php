...
function index()
	{
		...
		$this->form_validation->set_rules('first_name', 'First Name', 'required|min_length[5]|max_length[12]|alpha_numeric');
		$this->form_validation->set_rules('middle_name', 'Middle Name', 'required|min_length[5]|max_length[20]');
		$this->form_validation->set_rules('last_name', 'Last Name', 'required|min_length[5]|max_length[20]');
